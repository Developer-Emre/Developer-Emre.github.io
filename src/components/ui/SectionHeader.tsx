...
const SectionHeader = ({ id, label, heading, subtext, initial }: Props) => (
  ...
  >
    ...
    <motion.h2
      id={id}
      className="text-[clamp(2.4rem,5vw,3.8rem)] font-extrabold leading-[1.1] tracking-[-0.03em] text-foreground m-0"
      variants={fadeUpVariant}
    >
      {heading}
    </motion.h2>
    ...
    <motion.p
      className="text-base leading-[1.75] text-muted-foreground max-w-[52ch] m-0"
      variants={fadeUpVariant}
    >
      {subtext}
    </motion.p>
